...
const HEADLINE =
  "Мы верим, что современные маркетинговые и коммуникационные вызовы нужно решать единой командой, обогащённой профильными талантами и ИИ-системами.";
          ...
          <ul ref={listRef} className="main-directions__list">
            {items.map((item, index) => (
              <li key={item.id} className="main-directions__item">
                <Link
                  to={casePathForMainDirection(item.id)}
